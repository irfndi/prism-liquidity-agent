...
export function classifyWideningTarget(
  ...
  // A named dictionary alias is an owner contract: its declaration gives the
  // broad container a domain-level name and is the evidence-preserving form
  // this rule recommends instead of an inline Record annotation.
  if ((alias.typeParameters?.params.length ?? 0) === 0) return null;
