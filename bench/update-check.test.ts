    ...
    globalThis.fetch = asFetch(
      vi.fn().mockResolvedValue({
        ...
        json: vi.fn().mockResolvedValue({
          tag_name: "v0.0.0",
          html_url: "https://github.com/irfndi/prism-liquidity-agent/releases/tag/v0.0.0",
          body: "",
  ...
  it("forces shutdown when threshold exceeded and force enabled", async () => {
    globalThis.fetch = asFetch(
      vi.fn().mockResolvedValue({
        ...
        json: vi.fn().mockResolvedValue({
          tag_name: "v999.0.0",
          html_url: "https://github.com/irfndi/prism-liquidity-agent/releases/tag/v999.0.0",
          body: "",
          published_at: new Date().toISOString(),
          prerelease: false,
          assets: [],
